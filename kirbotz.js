...
module.exports = kirz = async (kirbotz, m, chatUpdate, store) => {
try {
...
const fakekirbotz = {
  ...
  message: {
    imageMessage: {
      mimetype: 'image/jpeg',
      caption: 'Created By Manz Executed',
...
kirbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Fitur Nulis By Manz ", fejfjej, { quoted: m })
break
case 'nuliskiri':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
kirbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Topup Game By Manz ", secmmknya, { quoted: efff })
break
case 'topup5':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!args[0]) return replyNya(`Example : \n${prefix + command} 946716486`)
...
hydratedFooterText: 'Created By Manz Executed',
hydratedButtons: [{
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/ManzzMD'
}
},
{
urlButton: {
...
break
case 'credits':
const sokl = "6283846819169@s.whatsapp.net"
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By Manz Executed`, global.thumb, btn)
}
break
...
kirbotz.send5ButImg(i, junn, `Created By Manz Executed`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `Created By Manz Executed`, buffer, butoon)
